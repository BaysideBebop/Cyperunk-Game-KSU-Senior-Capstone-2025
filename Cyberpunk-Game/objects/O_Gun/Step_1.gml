...
if (global.GunLayer > 0) or (global.GunLayer < 0) && (global.GunAngle = 0)
{
	...
	layer = layer_get_id("Gun");
	x = O_Player.x+16;
	if (O_Player.playerfalling > 0)	x = O_Player.x+12;
	}
}